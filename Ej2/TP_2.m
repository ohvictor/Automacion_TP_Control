...
%%Inicializacion Variables para Controlador No Lineal

Calculo de kvf y kpf% Control
% Criterio:
% Xi = 1 tal que la amortiguacion es CRITICAMENTE AMORTIGUADO
% Ts = Settling time = Step time = 0.01 y Ts = 4/(Xi*Ts) 
Xi = 1;            
Ts =  0.01;         
Wn = 4/(xi*ts);
Kpf = (Wn)^2;			% 400*400 = 160000
Kvf = 2*Xi*Wn;			% 2*1*400 = 800

%La relacion entre ambos es:
%Kv = 2*sqrt(Kp)
%Se verifica 800 = 2*sqrt(160000) 
